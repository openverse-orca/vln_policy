...
class BaseITMPolicy(BaseObjectNavPolicy):
    ...
    def __init__(
        ...
        **kwargs: Any,
        ...
        # print("BaseITMPolicy init finish--------")
    ...
    def _update_value_map(self) -> None:
        ...
        # img = self._value_map.visualize()
        # display_img(img, 80, "ValueMap")
...
class ITMPolicy(BaseITMPolicy):
    ...
    def _sort_frontiers_by_value(
        ...
        # img = self._frontier_map.visualize()
        # display_img(img,80,"frontier map")
